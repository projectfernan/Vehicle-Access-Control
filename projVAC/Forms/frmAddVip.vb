        ...
        If MsgBox("Are you sure do you want to delete this card?", vbYesNo + vbQuestion + vbDefaultButton2, "Delete") = vbYes Then
            ...
            For Each viewlst In lstCards.Items
                If viewlst.Selected = True Then
                    ...
                    With frmSystemMain
                        saveAudiUpdate(.UserAcc.Text, .SystemTag.Text, "Card Code : " & viewlst.SubItems(0).Text & " successfully deleted")
                    End With
                End If
            Next
        End If
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        If Me.Text = "New VIP" Then
            If MsgBox("Are you sure your entries are correct?    ", vbQuestion + vbYesNo, "Save") = vbYes Then
                save()
                With frmSystemMain
                    saveAudiUpdate(.UserAcc.Text, .SystemTag.Text, "Parker : " & txtName.Text & " successfully saved")
                End With
            End If
        Else
            If MsgBox("Are you sure do you want save changes?    ", vbQuestion + vbYesNo, "Save") = vbYes Then
                ...
                With frmSystemMain
                    saveAudiUpdate(.UserAcc.Text, .SystemTag.Text, "Parker : " & txtName.Text & " successfully updated")
                End With
            End If
        End If
    End Sub
