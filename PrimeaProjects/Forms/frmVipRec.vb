...
Public Class frmVipRec
    ...
    Sub fill()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = Conn.Execute("select * from tblOwner")
    ...
    Sub Findfill()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = Conn.Execute("select * from tblOwner where " & cboCateg.Text & " like '%" & txtInput.Text & "%'")
        If rs.EOF = False Then
            txtCount.Text = rs.RecordCount
            For lup = 1 To rs.RecordCount
                lstList.Refresh()
        ...
        With frmAddVip
            ...
            For Each viewlst In lstList.Items
                If viewlst.Selected = True Then
                    ...
                    .txtPosition.Text = viewlst.SubItems(2).Text
                    .cboGender.Text = viewlst.SubItems(3).Text
                    .dtBdate.Value = viewlst.SubItems(4).Text
                    .txtContactNo.Text = viewlst.SubItems(5).Text
