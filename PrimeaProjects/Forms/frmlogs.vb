...
Public Class frmlogs
    ...
    Sub EntHead()
        ...
        LstEmpRec.Columns.Add("Address", w, HorizontalAlignment.Left)
    ...
    Sub InOutAll()
        ...
        If rsLogs.EOF = False Then
            For lup = 1 To rsLogs.RecordCount
                ...
                viewlst.SubItems.Add(rsLogs("Address").Value)
    ...
    Sub Entall()
        ...
        If rsPRS.EOF = False Then
            For lup = 1 To rsPRS.RecordCount
                ...
                viewlst.SubItems.Add(rsPRS("Address").Value)
    ...
    Sub Extall()
        ...
        If rsIO.EOF = False Then
            For lup = 1 To rsIO.RecordCount
                ...
                viewlst.SubItems.Add(rsIO("Address").Value)
