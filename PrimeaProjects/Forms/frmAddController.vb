...
reconfig:
            ...
            Else
                MsgBox("Failed to configure! ", vbExclamation, "Save")
                Exit Sub
            End If
    ...
    Private Sub frmAddController_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        controler.ControllerSN = CInt(txtSN.Text)
        controler.IP = txtIP.Text
        controler.PORT = txtPort.Text
    End Sub
