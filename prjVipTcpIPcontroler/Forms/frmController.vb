        ...
        For Each viewlst In lstList.Items
            If viewlst.Selected = True Then
                With frmAddController
                    ...
                    .txtCam2.Value = CInt(viewlst.SubItems(16).Text)
                    .Cap2.Value = CInt(viewlst.SubItems(17).Text)
        ...
        For Each viewlst In lstList.Items
            If viewlst.Selected = True Then
                If MsgBox("Are you sure do you want to delete this controller? ", vbYesNo + vbQuestion + vbDefaultButton2, "Delete") = vbYes Then
                    ...
                    With frmSystemMain
                        saveAudiUpdate(.UserAcc.Text, .SystemTag.Text, "Controller : " & viewlst.SubItems(2).Text & " successfully deleted")
                    End With
                End If
            End If
        Next
